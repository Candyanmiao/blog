# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2018-08-10 08:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='wordpress.Category')),
            ],
            options={
                'db_table': 't_post',
        ...
        migrations.AddField(
            ...
            name='tag',
            field=models.ManyToManyField(to='wordpress.Tag'),
        ),
    ]
